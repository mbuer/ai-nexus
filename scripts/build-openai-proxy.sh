...
IMAGE="localhost/ai-nexus-openai-proxy:1"
...
podman build     --pull=never     --build-arg BASE_IMAGE="$pinned_base"     -t "$IMAGE"     "$REPO_ROOT/services/openai-proxy"

echo "OpenAI proxy image built: $IMAGE"
